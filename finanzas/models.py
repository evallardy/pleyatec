    ...
    class Meta:
        ...
        permissions = (
            ...
            # Toscana
                    ...
                    ('toscana_ver_comisiones', 'Nuvole ver comisiones'),
                    ('toscana_edita_comisiones_proyecto', 'Nuvole edita comisiones proyecto'),
                    ('toscana_pago_normal_comisiones', 'Nuvole pago normal comisiones'),
                    ('toscana_pago_extemp_comisiones', 'Nuvole pago extemp comisiones'),
                    ('toscana_consulta_comisiones', 'Nuvole consulta comisiones'),
            # Local Punta Oriente
                    ...
                    ('local_punta_o_ver_comisiones', 'Nuvole ver comisiones'),
                    ('local_punta_o_edita_comisiones_proyecto', 'Nuvole edita comisiones proyecto'),
                    ('local_punta_o_pago_normal_comisiones', 'Nuvole pago normal comisiones'),
                    ('local_punta_o_pago_extemp_comisiones', 'Nuvole pago extemp comisiones'),
                    ('local_punta_o_consulta_comisiones', 'Nuvole consulta comisiones'),
            # Consultorio Punta Oriente
                    ...
                    ('consul_punta_o_ver_comisiones', 'Nuvole ver comisiones'),
                    ('consul_punta_o_edita_comisiones_proyecto', 'Nuvole edita comisiones proyecto'),
                    ('consul_punta_o_pago_normal_comisiones', 'Nuvole pago normal comisiones'),
                    ('consul_punta_o_pago_extemp_comisiones', 'Nuvole pago extemp comisiones'),
                    ('consul_punta_o_consulta_comisiones', 'Nuvole consulta comisiones'),
            #  Torre Vento
                    ...
                    ('torre_vento_ver_comisiones', 'Nuvole ver comisiones'),
                    ('torre_vento_edita_comisiones_proyecto', 'Nuvole edita comisiones proyecto'),
                    ('torre_vento_pago_normal_comisiones', 'Nuvole pago normal comisiones'),
                    ('torre_vento_pago_extemp_comisiones', 'Nuvole pago extemp comisiones'),
                    ('torre_vento_consulta_comisiones', 'Nuvole consulta comisiones'),
            #  Fracción 34
                    ('porto_santo_listado_registro_mensual', 'Fracción 34 listado registro mensualidades'),
                    ('porto_santo_estado_cuenta', 'Fracción 34 Mostrar estado de cuenta'),
                    ('porto_santo_cap_dep_mensual', 'Fracción 34 capturar depósito mensualidad'),
                    ('porto_santo_imp_estado_cuenta', 'Fracción 34 imprime estado de cuenta'),
                    ('porto_santo_inluye_comprob_mensual', 'Fracción 34 Incluir comprobante de mensualidad'),
                    ('porto_santo_confirma_deposito_mensual', 'Fracción 34 Confirma depósito mensualidad'),
                    ('porto_santo_confirma_deposito_pago', 'Fracción 34 Confirma depósito pago'),
                    ('porto_santo_ver_comisiones', 'Nuvole ver comisiones'),
                    ('porto_santo_edita_comisiones_proyecto', 'Nuvole edita comisiones proyecto'),
                    ('porto_santo_pago_normal_comisiones', 'Nuvole pago normal comisiones'),
                    ('porto_santo_pago_extemp_comisiones', 'Nuvole pago extemp comisiones'),
                    ('porto_santo_consulta_comisiones', 'Nuvole consulta comisiones'),
            #  Vivienda Nuvole
                    ...
                    ('vivienda_nuvole_ver_comisiones', 'Nuvole ver comisiones'),
                    ('vivienda_nuvole_edita_comisiones_proyecto', 'Nuvole edita comisiones proyecto'),
                    ('vivienda_nuvole_pago_normal_comisiones', 'Nuvole pago normal comisiones'),
                    ('vivienda_nuvole_pago_extemp_comisiones', 'Nuvole pago extemp comisiones'),
                    ('vivienda_nuvole_consulta_comisiones', 'Nuvole consulta comisiones'),
            #  Monte Cristalo
                    ('monte_cristalo_listado_registro_mensual', 'Monte cristalo listado registro mensualidades'),
                    ('monte_cristalo_estado_cuenta', 'Monte cristalo Mostrar estado de cuenta'),
                    ('monte_cristalo_cap_dep_mensual', 'Monte cristalo capturar depósito mensualidad'),
                    ('monte_cristalo_imp_estado_cuenta', 'Monte cristalo imprime estado de cuenta'),
                    ('monte_cristalo_inluye_comprob_mensual', 'Monte cristalo Incluir comprobante de mensualidad'),
                    ('monte_cristalo_confirma_deposito_mensual', 'Monte cristalo Confirma depósito mensualidad'),
                    ('monte_cristalo_confirma_deposito_pago', 'Monte cristalo Confirma depósito pago'),
                    ('monte_cristalo_ver_comisiones', 'Nuvole ver comisiones'),
                    ('monte_cristalo_edita_comisiones_proyecto', 'Nuvole edita comisiones proyecto'),
                    ('monte_cristalo_pago_normal_comisiones', 'Nuvole pago normal comisiones'),
                    ('monte_cristalo_pago_extemp_comisiones', 'Nuvole pago extemp comisiones'),
                    ('monte_cristalo_consulta_comisiones', 'Nuvole consulta comisiones'),
            #  Condominio Múltiple
                    ...
                    ('condom_multiple_ver_comisiones', 'Nuvole ver comisiones'),
                    ('condom_multiple_edita_comisiones_proyecto', 'Nuvole edita comisiones proyecto'),
                    ('condom_multiple_pago_normal_comisiones', 'Nuvole pago normal comisiones'),
                    ('condom_multiple_pago_extemp_comisiones', 'Nuvole pago extemp comisiones'),
                    ('condom_multiple_consulta_comisiones', 'Nuvole consulta comisiones'),
                    )
