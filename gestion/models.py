...
class Solicitud(models.Model, PermissionRequiredMixin):
    ...
    confirmacion_pago_adicional = models.BooleanField("Confirmación pago adicional", default=False)
    apartado = models.DecimalField("Apartado", decimal_places=2, max_digits=10, null=True, blank=True, default=0)
    confirmacion_apartado = models.BooleanField("Confirmación apartado", default=False)
