...
#  Pago apartado
    ...
    cuenta_apa = models.CharField("Número de cuenta apartado",max_length=4, default=" ")
    numero_comprobante_apa = models.CharField("Número de comprobante apartado",max_length=40, default=" ")
#  Pago adicional
    ...
    cuenta_pa = models.CharField("Número de cuenta pago adic",max_length=4, default="")
    numero_comprobante_pa = models.CharField("Número de comprobante pago adic",max_length=40, default="")
    ...
    foto_elector_frente = models.FileField(upload_to="ine", default=" ")
    foto_elector_reverso = models.FileField(upload_to="ine", default=" ")
    foto_elector_frente_cy = models.FileField(upload_to="ine_cy", default=" ")
    foto_elector_reverso_cy = models.FileField(upload_to="ine_cy", default=" ")
    foto_matrimonio = models.FileField(upload_to="matrimonio", default=" ")
    foto_comprobante = models.FileField(upload_to="comprobante", default=" ")
    foto_alta_shcp = models.FileField(upload_to="alta_shcp", default=" ")
    foto_acta_const = models.FileField(upload_to="acte_const", default=" ")
    ...
    razon = models.CharField("Razón social",max_length=255, default=" ")
    ...
    correo = models.EmailField("Correo", max_length=180, default=" ")
