...
#  Pago apartado
    ...
    foto_comprobante_apartado = models.FileField(upload_to="compApartado", blank=True, null=True,default=" ")
...
#  Pago adicional
    ...
    foto_comprobante_pago_adicional = models.FileField(upload_to="compAdicional", blank=True, null=True,default=" ")
    ...
    foto_elector_frente = models.FileField(upload_to="ine", blank=True, null=True,default=" ")
    foto_elector_reverso = models.FileField(upload_to="ine", blank=True, null=True,default=" ")
    foto_elector_frente_cy = models.FileField(upload_to="ine_cy", blank=True, null=True,default=" ")
    foto_elector_reverso_cy = models.FileField(upload_to="ine_cy", blank=True, null=True,default=" ")
    foto_matrimonio = models.FileField(upload_to="matrimonio", blank=True, null=True,default=" ")
    foto_comprobante = models.FileField(upload_to="comprobante", blank=True, null=True,default=" ")
    foto_alta_shcp = models.FileField(upload_to="alta_shcp", blank=True, null=True,default=" ")
    foto_acta_const = models.FileField(upload_to="acte_const", blank=True, null=True,default=" ")
    ...
    class Meta:
        ...
        permissions = (
            ...
            #  Fracción 34
                        ('porto_santo_ver_solicitud', 'Fracción 34 Listado ver solicitudes'),
                        ('porto_santo_add_solicitud', 'Fracción 34 agrega solicitud'),
                        ('porto_santo_cambia_solicitud', 'Fracción 34 cambia solicitud'),
                        ('porto_santo_cancela_solicitud', 'Fracción 34 cancela solicitud'),
                        ('porto_santo_asigna_descto', 'Fracción 34 asigna descto solicitud'),
                        ('porto_santo_amortizac', 'Fracción 34 Listado de amortización'),
                        ('porto_santo_imprime_amortizac', 'Fracción 34 Imprime listado de amortización'),
                        ('porto_santo_autoriza_visualiza', 'Fracción 34 Ver autorizaciones'),
                        ('porto_santo_autoriza_venta', 'Fracción 34 Autoriza solicitud por Gerente ventas'),
                        ('porto_santo_autoriza_desarrollo', 'Fracción 34 Autoriza solicitud por Director desarrollo'),
                        ('porto_santo_compromiso', 'Fracción 34 Realiza compromiso de compra'),
                        ('porto_santo_pago_compromiso', 'Fracción 34 Realizar pago compromiso'),
                        ('porto_santo_imp_pago_compromiso', 'Fracción 34 imprime pago compromiso'),
                        ('porto_santo_contratar', 'Fracción 34 Generar contrato'),
                        ('porto_santo_datos_contrato', 'Fracción 34 Incluir datos al contrato'),
                        ('porto_santo_imprime_contrato', 'Fracción 34 Impresión de contrato'),
                        ('porto_santo_archivar_contrato', 'Fracción 34 Archivar contrato'),
                        ('porto_santo_consulta_archivo', 'Fracción 34 Consultar el histórico de solicitudes'),
                        ('porto_santo_creditos', 'Fracción 34 Consulta contratos a crédito'),
                        ('porto_santo_contados', 'Fracción 34 Consulta contratos de contado'),
            #  Vivienda Nuvole
            ...
            #  Monte Cristalo
                        ('monte_cristalo_ver_solicitud', 'Monte cristalo Listado ver solicitudes'),
                        ('monte_cristalo_add_solicitud', 'Monte cristalo agrega solicitud'),
                        ('monte_cristalo_cambia_solicitud', 'Monte cristalo cristalo cambia solicitud'),
                        ('monte_cristalo_cancela_solicitud', 'Monte cristalo cancela solicitud'),
                        ('monte_cristalo_asigna_descto', 'Monte cristalo asigna descto solicitud'),
                        ('monte_cristalo_cristalo_amortizac', 'Monte cristalo Listado de amortización'),
                        ('monte_cristalo_cristalo_imprime_amortizac', 'Monte cristalo Imprime listado de amortización'),
                        ('monte_cristalo_cristalo_autoriza_visualiza', 'Monte cristalo Ver autorizaciones'),
                        ('monte_cristalo_cristalo_autoriza_venta', 'Monte cristalo Autoriza solicitud por Gerente ventas'),
                        ('monte_cristalo_autoriza_desarrollo', 'Monte cristalo Autoriza solicitud por Director desarrollo'),
                        ('monte_cristalo_compromiso', 'Monte cristalo Realiza compromiso de compra'),
                        ('monte_cristalo_pago_compromiso', 'Monte cristalo Realizar pago compromiso'),
                        ('monte_cristalo_imp_pago_compromiso', 'Monte cristalo imprime pago compromiso'),
                        ('monte_cristalo_contratar', 'Monte cristalo Generar contrato'),
                        ('monte_cristalo_datos_contrato', 'Monte cristalo Incluir datos al contrato'),
                        ('monte_cristalo_imprime_contrato', 'Monte cristalo Impresión de contrato'),
                        ('monte_cristalo_archivar_contrato', 'Monte cristalo Archivar contrato'),
                        ('monte_cristalo_consulta_archivo', 'Monte cristalo Consultar el histórico de solicitudes'),
                        ('monte_cristalo_creditos', 'Monte cristalo Consulta contratos a crédito'),
                        ('monte_cristalo_contados', 'Monte cristalo Consulta contratos de contado'),
            #  Condominio Múltiple
